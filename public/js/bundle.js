...
var updatedSettings = exports.updatedSettings = /*#__PURE__*/function () {
  ...
  return function updatedSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSetting.updatedSettings)(form, 'data');
  });
}
if (userPasswordForm) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.n = 1;
            return (0, _updateSetting.updatedSettings)({
